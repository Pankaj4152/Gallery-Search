  ...
  return (
    <div className="bg-zinc-900">            
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <h2 className="text-white text-3xl font-bold text-center mb-12 text-gray-800">Key Features</h2>
        
        {/* Feature 1 */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-neutral-950 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            <div className="text-cyan-700 mb-4">
              <svg className="w-10 h-10 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
            </div>
            <h3 className="text-white text-xl font-semibold mb-3 text-center">AI-Powered Search</h3>
          ...
          <div className="bg-neutral-950 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-white text-xl font-semibold mb-3 text-center">Easy Upload</h3>
            <p className="text-gray-400 text-center">
          ...
          <div className="bg-neutral-950 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-white text-xl font-semibold mb-3 text-center">Smart Gallery</h3>
            <p className="text-gray-400 text-center">
      ...
      {/* Call to Action */}
      <section className="bg-gradient-to-r from-zinc-900 to-neutral-800 py-16 px-4 bg-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6 text-white">Ready to organize your images?</h2>
          <p className="text-xl mb-8 text-gray-300">Join thousands of users managing their visual content efficiently</p>
          <Link 
            to="/signup" 
