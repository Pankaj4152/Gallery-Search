"""
Django settings for GallerySearch project.
...
SECRET_KEY = "django-insecure-iode#d#0=kycge_wo6+ehglc43mybg#sn-t**m_8y7ai+*&mas"
...
# Add the external apps to the installed apps
...
WSGI_APPLICATION = "GallerySearch.wsgi.application"
